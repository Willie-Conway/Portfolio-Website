...
![Dark Mode](https://img.shields.io/badge/Dark_Mode-000000?style=for-the-badge&logo=darkreader&logoColor=white)
...
- **Interactive Pie Charts**: Visual skill distribution across 12+ categories
- **Dynamic Bar/Line Charts**: Skill progression timelines from 2020-2025
- **Real-time Animations**: Animate charts with single click
...
- **50+ Credly Badges**: Professional certifications from IBM, Google, Meta, Microsoft
- **Interactive Carousel**: Responsive badge display with search functionality
- **Direct Credly Links**: One-click access to verification
- **Category Filtering**: Search by IBM, Google, Cloud, Data, Security, etc.
...
- ✅ **Resume/CV Download** with Google Drive integration
...
- **Glass Effects**: Modern UI design patterns
...
4. **Cloud Platforms** (Google Cloud, AWS, Azure, IBM Cloud)
5. **Mobile Development** (Flutter, Kotlin, Swift, Dart)
6. **Cybersecurity** (Network Security, Cloud Security, SIEM)
7. **Soft Skills** (Leadership, Communication, Problem-Solving)
8. **Software Development** (JavaScript, React, Node.js, Java)
9. **Data Engineering** (Apache Spark, Hadoop, Airflow, Kafka)
...
- **Microsoft** (Azure Security, Power BI, Cybersecurity)
...
4. **Cybersecurity** (IBM Cybersecurity, Google Cloud Cybersecurity)
5. **AI & Machine Learning** (IBM AI Engineering, Generative AI)
...
- **CSS Optimization**: Tailwind's utility classes
...
- **HTTPS Only**: GitHub Pages enforced SSL
...
- **Credly** for certification verification platform
...
> 🚀 *Built with passion by Willie Conway – transforming data into insights and code into solutions.*
